...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
	...
	/**
	 * The item view type returned by {@link Adapter#getItemViewType(int)} when the com.awrtechnologies.carbudgetsales.adapter does not want the item's view recycled.
	 */
	...
	/**
	 * Col id to look for when com.awrtechnologies.carbudgetsales.data has changed
	 */
	...
	/**
	 * True if the com.awrtechnologies.carbudgetsales.data has changed since the last layout
	 * @hide
	 */
	public boolean mDataChanged;

	/**
	 * The position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set of the item to select during the next layout.
	 */
	...
	/**
	 * The position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set of the currently selected item.
	 */
	@ViewDebug.ExportedProperty(category = "list")
	...
	/**
	 * The number of items in the current com.awrtechnologies.carbudgetsales.adapter.
	 */
	@ViewDebug.ExportedProperty(category = "list")
	protected int mItemCount;

	/**
	 * The number of items in the com.awrtechnologies.carbudgetsales.adapter before a com.awrtechnologies.carbudgetsales.data changed event occurred.
	 */
	 ...
	 * com.awrtechnologies.carbudgetsales.adapter.
	 */
	...
	public interface OnItemClickListener {
		 ...
		 * <p>
		 * Implementers can call getItemAtPosition(position) if they need to access the com.awrtechnologies.carbudgetsales.data associated with the selected item.
		 * 
		 * @param parent
		 *           The AdapterView where the click happened.
		 * @param view
		 *           The view within the AdapterView that was clicked (this will be a view provided by the com.awrtechnologies.carbudgetsales.adapter)
		 * @param position
		 *           The position of the view in the com.awrtechnologies.carbudgetsales.adapter.
		 * @param id
	...
	public interface OnItemSelectedListener {
		 ...
		 * </p>
		 * 
		 * Impelmenters can call getItemAtPosition(position) if they need to access the com.awrtechnologies.carbudgetsales.data associated with the selected item.
		 * 
		 * @param parent
		 ...
		 * touch is activated or when the com.awrtechnologies.carbudgetsales.adapter becomes empty.
		 * 
		 * @param parent
	...
	public static class AdapterContextMenuInfo implements ContextMenu.ContextMenuInfo {
		...
		/**
		 * The position in the com.awrtechnologies.carbudgetsales.adapter for which the context menu is being displayed.
		 */
		public int position;
	...
	/**
	 * Returns the com.awrtechnologies.carbudgetsales.adapter currently associated with this widget.
	 * 
	 * @return The com.awrtechnologies.carbudgetsales.adapter used to provide this view's content.
	 */
	public abstract T getAdapter();

	/**
	 * Sets the com.awrtechnologies.carbudgetsales.adapter that provides the com.awrtechnologies.carbudgetsales.data and the views to represent the com.awrtechnologies.carbudgetsales.data in this widget.
	 * 
	 * @param adapter
	 *           The com.awrtechnologies.carbudgetsales.adapter to use to create this view's content.
	 */
	...
	/**
	 * Return the position of the currently selected item within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set
	 * 
	...
	/**
	 * @return The com.awrtechnologies.carbudgetsales.data corresponding to the currently selected item, or null if there is nothing selected.
	 */
	...
	/**
	 * @return The number of items owned by the Adapter associated with this AdapterView. (This is the number of com.awrtechnologies.carbudgetsales.data items, which
	...
	/**
	 * Get the position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set for the view, where view is a an com.awrtechnologies.carbudgetsales.adapter item or a descendant of an com.awrtechnologies.carbudgetsales.adapter
	 * item.
	 * 
	 * @param view
	 *           an com.awrtechnologies.carbudgetsales.adapter item, or a descendant of an com.awrtechnologies.carbudgetsales.adapter item. This must be visible in this AdapterView at the time of the
	 *           call.
	 * @return the position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set of the view, or {@link #INVALID_POSITION} if the view does not correspond
	...
	/**
	 * Returns the position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set for the first item displayed on screen.
	 * 
	 * @return The position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set
	 */
	...
	/**
	 * Returns the position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set for the last item displayed on screen.
	 * 
	 * @return The position within the com.awrtechnologies.carbudgetsales.adapter's com.awrtechnologies.carbudgetsales.data set
	 */
	 ...
	 * 
	 * @param position
	 *           Index (starting at 0) of the com.awrtechnologies.carbudgetsales.data item to be selected.
	 */
	public abstract void setSelection( int position );

	/**
	 * Sets the view to show if the com.awrtechnologies.carbudgetsales.adapter is empty
	 */
	@TargetApi(16)
	...
	/**
	 * When the current com.awrtechnologies.carbudgetsales.adapter is empty, the AdapterView can display a special view call the empty view. The empty view is used to
	 * provide feedback to the user that no com.awrtechnologies.carbudgetsales.data is available in this AdapterView.
	 * 
	 * @return The view to show if the com.awrtechnologies.carbudgetsales.adapter is empty.
	 */
	...
	private void updateEmptyStatus( boolean empty ) {
		...
		if ( empty ) {
			...
			// the state of the com.awrtechnologies.carbudgetsales.adapter.
			if ( mDataChanged ) {
	...
	/**
	 * Gets the com.awrtechnologies.carbudgetsales.data associated with the specified position in the list.
	 * 
	 * @param position
	 *           Which com.awrtechnologies.carbudgetsales.data to get
	 * @return The com.awrtechnologies.carbudgetsales.data associated with the specified position in the list
	 */
	...
	/**
	 * Override to prevent freezing of any views created by the com.awrtechnologies.carbudgetsales.adapter.
	 */
	@Override
	...
	/**
	 * Override to prevent thawing of any views created by the com.awrtechnologies.carbudgetsales.adapter.
	 */
	@Override
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			...
			// been repopulated with new com.awrtechnologies.carbudgetsales.data.
	...
	private class SelectionNotifier implements Runnable {
		...
		public void run() {
			if ( mDataChanged ) {
				...
				// has been synched to the new com.awrtechnologies.carbudgetsales.data.
				if ( getAdapter() != null ) {
					post( this );
				}
			} else {
	...
	void handleDataChanged() {
		...
		if ( count > 0 ) {
			...
			if ( !found ) {
				// Try to use the same position if we can't find matching com.awrtechnologies.carbudgetsales.data
	...
	/**
	 * Searches the com.awrtechnologies.carbudgetsales.adapter for a position matching mSyncColId. The search starts at mSyncPosition and then alternates between moving
	...
	int findSyncPosition() {
		...
		// True when we have looked at the first item in the com.awrtechnologies.carbudgetsales.data
		boolean hitFirst;

		// True when we have looked at the last item in the com.awrtechnologies.carbudgetsales.data
		boolean hitLast;

		// Get the item ID locally (instead of getItemIdAtPosition), so
		// we need the com.awrtechnologies.carbudgetsales.adapter
		T adapter = getAdapter();
		if ( adapter == null ) {
			return INVALID_POSITION;
		}
	...
	/**
	 * Remember enough information to restore the screen state when the com.awrtechnologies.carbudgetsales.data has changed.
	 * @hide
	 */
