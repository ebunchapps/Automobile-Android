...
/**
 * A {@link android.widget.BaseAdapter} that provides com.awrtechnologies.carbudgetsales.data/Views in an expandable list (offers
 * features such as collapsing/expanding groups containing children). By
 * itself, this com.awrtechnologies.carbudgetsales.adapter has no com.awrtechnologies.carbudgetsales.data and is a connector to a
 * {@link android.widget.ExpandableListAdapter} which provides the com.awrtechnologies.carbudgetsales.data.
 * <p/>
...
class ExpandableHListConnector extends BaseAdapter implements Filterable {
	/**
	 * The ExpandableListAdapter to fetch the com.awrtechnologies.carbudgetsales.data/Views for this expandable list
	 */
	private ExpandableListAdapter mExpandableListAdapter;

	/**
	 * List of metadata for the currently expanded groups. The metadata consists
	 * of com.awrtechnologies.carbudgetsales.data essential for efficiently translating between flat list positions
	...
	/**
	 * Point to the {@link android.widget.ExpandableListAdapter} that will give us com.awrtechnologies.carbudgetsales.data/Views
	 *
	 * @param expandableListAdapter the com.awrtechnologies.carbudgetsales.adapter that supplies us with com.awrtechnologies.carbudgetsales.data/Views
	 */
	...
	void setExpandedGroupMetadataList( ArrayList<GroupMetadata> expandedGroupMetadataList ) {
		...
		// Make sure our current com.awrtechnologies.carbudgetsales.data set is big enough for the previously
	...
	/**
	 * Searches the expandable list com.awrtechnologies.carbudgetsales.adapter for a group position matching the
