 ...
 * differs from the {@link com.awrtechnologies.hlistview.widget.HListView} by allowing two levels: groups which can
...
public class ExpandableHListView extends HListView {
	...
	private Drawable getIndicator( ExpandableHListConnector.PositionMetadata pos ) {
		...
		if( pos.position.type == ExpandableHListPosition.GROUP ) {
			...
			if( indicator != null && indicator.isStateful() ) {
				// Empty check based on availability of com.awrtechnologies.carbudgetsales.data.  If the groupMetadata isn't null,
	...
	/**
	 * Sets the com.awrtechnologies.carbudgetsales.adapter that provides com.awrtechnologies.carbudgetsales.data to this view.
	 *
	 * @param adapter The com.awrtechnologies.carbudgetsales.adapter that provides com.awrtechnologies.carbudgetsales.data to this view.
	 */
	public void setAdapter( ExpandableListAdapter adapter ) {
		...
		// Link the ListView (superclass) to the expandable list com.awrtechnologies.carbudgetsales.data through the connector
		super.setAdapter( mConnector );
	}

	/**
	 * Gets the com.awrtechnologies.carbudgetsales.adapter that provides com.awrtechnologies.carbudgetsales.data to this view.
	 *
	 * @return The com.awrtechnologies.carbudgetsales.adapter that provides com.awrtechnologies.carbudgetsales.data to this view.
	 */
	...
	public static class ExpandableListContextMenuInfo implements ContextMenu.ContextMenuInfo {
		...
		/**
		 * The packed position in the list represented by the com.awrtechnologies.carbudgetsales.adapter for which
