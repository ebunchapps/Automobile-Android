...
public class HListView extends AbsHListView {
	...
	public static class FixedViewInfo {
		...
		public View view;
		/** The com.awrtechnologies.carbudgetsales.data backing the view. This is returned from {@link ListAdapter#getItem(int)}. */
		public Object data;
	...
	public void addFooterView( View v, Object data, boolean isSelectable ) {
		...
		// NOTE: do not enforce the com.awrtechnologies.carbudgetsales.adapter being null here, since unlike in
	...
	/**
	 * Returns the com.awrtechnologies.carbudgetsales.adapter currently in use in this ListView. The returned com.awrtechnologies.carbudgetsales.adapter might not be the same com.awrtechnologies.carbudgetsales.adapter passed to
	 * {@link #setAdapter(ListAdapter)} but might be a {@link WrapperListAdapter}.
	 * 
	 * @return The com.awrtechnologies.carbudgetsales.adapter currently used to display com.awrtechnologies.carbudgetsales.data in this ListView.
	 * 
	...
	/**
	 * Sets the com.awrtechnologies.carbudgetsales.data behind this ListView.
	 * 
	 * The com.awrtechnologies.carbudgetsales.adapter passed to this method may be wrapped by a {@link WrapperListAdapter}, depending on the ListView features currently
	 * in use. For instance, adding headers and/or footers will cause the com.awrtechnologies.carbudgetsales.adapter to be wrapped.
	 * 
	 * @param adapter
	 *           The ListAdapter which is responsible for maintaining the com.awrtechnologies.carbudgetsales.data backing this list and for producing a view to
	 *           represent an item in that com.awrtechnologies.carbudgetsales.data set.
	 * 
	 * @see #getAdapter()
	 */
	@Override
	...
	/**
	 * Smoothly scroll to the specified com.awrtechnologies.carbudgetsales.adapter position offset. The view will scroll such that the indicated position is displayed.
	 * 
	 * @param offset
	 *           The amount to offset from the com.awrtechnologies.carbudgetsales.adapter position to scroll to.
	 */
	@Override
	...
	protected void layoutChildren() {
		...
		try {
			...
			if ( mItemCount == 0 ) {
				...
				throw new IllegalStateException( "The content of the com.awrtechnologies.carbudgetsales.adapter has changed but "
	...
	static private class ArrowScrollFocusResult {
		...
		/**
		 * How {@link com.awrtechnologies.hlistview.widget.HListView#arrowScrollFocused} returns its values.
		 */
