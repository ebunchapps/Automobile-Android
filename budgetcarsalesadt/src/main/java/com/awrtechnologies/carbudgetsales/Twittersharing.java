...
public class Twittersharing extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		intent.setPackage("com.com.awrtechnologies.carbudgetsales.twitter.android");
			...
			try {
				...
				if (jobject.getInt("response_code") == 1) {
					try {
						...
						try {
							Toast.makeText(Twittersharing.this,
				...
				try {
					...
					Toast.makeText(Twittersharing.this, "Undefined Error!",
							Toast.LENGTH_SHORT).show();
				}
				e.printStackTrace();
			}
