...
public class Vehiclereceiptadapter extends BaseAdapter{
	Context context;
	...
	public Vehiclereceiptadapter(Context context, VehicleInfo vehicleinfo) {
...
//		image.setLayoutParams(new LinearLayout.LayoutParams(85, 85));
