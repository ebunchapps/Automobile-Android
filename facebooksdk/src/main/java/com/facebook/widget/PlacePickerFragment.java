...
public class PlacePickerFragment extends PickerFragment<GraphPlace> {
    ...
    /**
     * Sets the search text and reloads the com.awrtechnologies.carbudgetsales.data in the control. This is used to provide search-box
     * functionality where the user may be typing or editing text rapidly. It uses a timer to avoid repeated
     * requerying, preferring to wait until the user pauses typing to refresh the com.awrtechnologies.carbudgetsales.data. Note that this
                    ...
                    try {
                        ...
                        if (error != null) {
                            ...
                            if (onErrorListener != null) {
                                ...
                                Logger.log(LoggingBehavior.REQUESTS, TAG, "Error loading com.awrtechnologies.carbudgetsales.data : %s", error);
                            }
                        }
                    }
                }
    ...
    private class AsNeededLoadingStrategy extends LoadingStrategy {
        ...
        public void attach(GraphObjectAdapter<GraphPlace> adapter) {
            ...
            this.adapter.setDataNeededListener(new GraphObjectAdapter.DataNeededListener() {
                ...
                public void onDataNeeded() {
                    // Do nothing if we are currently loading com.awrtechnologies.carbudgetsales.data . We will get notified again when that load finishes if the com.awrtechnologies.carbudgetsales.adapter still
                    // needs more com.awrtechnologies.carbudgetsales.data. Otherwise, follow the next link.
                    if (!loader.isLoading()) {
        ...
        protected void onLoadFinished(GraphObjectPagingLoader<GraphPlace> loader,
            ...
            // We could be called in this state if we are clearing com.awrtechnologies.carbudgetsales.data or if we are being re-attached
            ...
            if (data.isFromCache()) {
                ...
                // no com.awrtechnologies.carbudgetsales.data, launch the refresh immediately, otherwise schedule it for later.
