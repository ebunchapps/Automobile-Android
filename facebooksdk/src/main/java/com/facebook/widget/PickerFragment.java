 ...
 * underlying com.awrtechnologies.carbudgetsales.data has been changed, or when the set of selected graph objects changes.
 */
public abstract class PickerFragment<T extends GraphObject> extends Fragment {
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        sessionTracker = new SessionTracker(getActivity(), new Session.StatusCallback() {
            ...
            public void call(Session session, SessionState state, Exception exception) {
                if (!session.isOpened()) {
                    // When a session is closed, we want to clear out our com.awrtechnologies.carbudgetsales.data so it is not visible to subsequent users
                    clearResults();
                }
            }
        });
     ...
     * the underlying com.awrtechnologies.carbudgetsales.data being displaying in the picker has changed.
     *
    ...
    /**
     * Causes the picker to load com.awrtechnologies.carbudgetsales.data from the service and display it to the user.
     *
     * @param forceReload if true, com.awrtechnologies.carbudgetsales.data will be loaded even if there is already com.awrtechnologies.carbudgetsales.data being displayed (or loading);
     *                    if false, com.awrtechnologies.carbudgetsales.data will not be re-loaded if it is already displayed (or loading)
     */
     ...
     * @param forceReload if true, com.awrtechnologies.carbudgetsales.data will be loaded even if there is already com.awrtechnologies.carbudgetsales.data being displayed (or loading);
     *                    if false, com.awrtechnologies.carbudgetsales.data will not be re-loaded if it is already displayed (or loading)
     * @param selectIds ids to select, if they are present in the loaded com.awrtechnologies.carbudgetsales.data
     */
    ...
    void layoutActivityCircle() {
        // If we've got no com.awrtechnologies.carbudgetsales.data, make the activity circle full-opacity. Otherwise we'll dim it to avoid
        //  cluttering the UI.
    ...
    private void clearResults() {
        if (adapter != null) {
            ...
            // Tell anyone who cares the com.awrtechnologies.carbudgetsales.data and selection has changed, if they have.
    ...
    /**
     * Callback interface that will be called when the underlying com.awrtechnologies.carbudgetsales.data being displayed in the
     * picker has been updated.
     */
    public interface OnDataChangedListener {
        /**
         * Called when the set of com.awrtechnologies.carbudgetsales.data being displayed in the picker has changed.
         */
    ...
    abstract class LoadingStrategy {
        ...
        public void attach(GraphObjectAdapter<T> adapter) {
            ...
            // Tell the com.awrtechnologies.carbudgetsales.adapter about any com.awrtechnologies.carbudgetsales.data we might already have.
