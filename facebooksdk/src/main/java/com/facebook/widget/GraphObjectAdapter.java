...
class GraphObjectAdapter<T extends GraphObject> extends BaseAdapter implements SectionIndexer {
    ...
    private boolean shouldShowActivityCircleCell() {
        // We show the "more com.awrtechnologies.carbudgetsales.data" activity circle cell if we have a listener to request more com.awrtechnologies.carbudgetsales.data,
        // we are expecting more com.awrtechnologies.carbudgetsales.data, and we have some com.awrtechnologies.carbudgetsales.data already (i.e., not on a fresh query).
    ...
    SectionAndItem<T> getSectionAndItem(int position) {
        ...
        if (!displaySections) {
            ...
            if (position >= 0 && position < section.size()) {
                ...
                // We are off the end; we must be adding an activity circle to indicate more com.awrtechnologies.carbudgetsales.data is coming.
    ...
    public int getCount() {
        ...
        // If we should show a cell with an activity circle indicating more com.awrtechnologies.carbudgetsales.data is coming, add it to the count.
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (sectionAndItem.getType()) {
            ...
            case ACTIVITY_CIRCLE:
                // If we get a request for this view, it means we need more com.awrtechnologies.carbudgetsales.data.
