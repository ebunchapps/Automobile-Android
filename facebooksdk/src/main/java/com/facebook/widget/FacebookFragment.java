...
class FacebookFragment extends Fragment {
     ...
     * the associated meta-com.awrtechnologies.carbudgetsales.data value and an empty list of permissions.
     */
     ...
     * meta-com.awrtechnologies.carbudgetsales.data value and an empty list respectively.
     *
     ...
     * meta-com.awrtechnologies.carbudgetsales.data value. The permissions list cannot be null.
     *
     * @param applicationId the applicationID, can be null
