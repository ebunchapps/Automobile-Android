 ...
 * if it has the available com.awrtechnologies.carbudgetsales.data (if the app ID is specified in the manifest).
...
public class LoginButton extends Button {
     ...
     *            call.
     * @param data
     *            The Intent passed as the com.awrtechnologies.carbudgetsales.data parameter from the forwarded
     *            call.
