...
class FacebookTimeSpentData implements Serializable {
    ...
    // Member com.awrtechnologies.carbudgetsales.data that's persisted to disk
    ...
    private void logAppDeactivatedEvent(AppEventsLogger logger,
        ...
        // Log the old session information and clear the com.awrtechnologies.carbudgetsales.data
        Bundle eventParams = new Bundle();
        eventParams.putInt(
