...
public class Request {
     ...
     * allow you to post binary com.awrtechnologies.carbudgetsales.data such as images, in preparation for a post of an Open Graph object or action
    ...
    private static String getMimeContentType() {
        return String.format("multipart/form-com.awrtechnologies.carbudgetsales.data; boundary=%s", MIME_BOUNDARY);
    }
    ...
    private static class Serializer implements KeyValueSerializer {
        ...
        public void writeContentDisposition(String name, String filename, String contentType) throws IOException {
            write("Content-Disposition: form-com.awrtechnologies.carbudgetsales.data; name=\"%s\"", name);
            if (filename != null) {
