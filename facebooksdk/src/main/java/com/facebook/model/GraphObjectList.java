...
public interface GraphObjectList<T> extends List<T> {
    ...
    /**
     * If T is derived from GraphObject, returns a new GraphObjectList exposing the same underlying com.awrtechnologies.carbudgetsales.data as a new
     * GraphObject-derived type.
     * @param graphObjectClass the GraphObject-derived type to return a list of
     * @return a list representing the same underlying com.awrtechnologies.carbudgetsales.data, exposed as the new GraphObject-derived type
    ...
    /**
     * Gets the underlying JSONArray representation of the com.awrtechnologies.carbudgetsales.data.
     * @return the underlying JSONArray representation of the com.awrtechnologies.carbudgetsales.data
     */
