 ...
 * GraphObject, if you wish to provide a setter that takes a primitive com.awrtechnologies.carbudgetsales.data type (e.g., String)
 * or a List of primitive com.awrtechnologies.carbudgetsales.data types, but actually populates its underlying property with a
 * new GraphObject with a property equal to the specified value (or a List of such GraphObjects).
 * This is useful for providing "com.awrtechnologies.carbudgetsales.helper" setters to avoid requiring callers to instantiate a GraphObject
