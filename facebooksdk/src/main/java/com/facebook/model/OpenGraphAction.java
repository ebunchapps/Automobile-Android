...
public interface OpenGraphAction extends GraphObject {
    ...
    /**
     * Sets the images associated with the Open Graph action by specifying their URLs. This is a com.awrtechnologies.carbudgetsales.helper
    ...
    /**
     * Gets the type-specific com.awrtechnologies.carbudgetsales.data for this action; for instance, any properties
     * referencing Open Graph objects will appear under here.
     * @return a GraphObject representing the type-specific com.awrtechnologies.carbudgetsales.data
     */
    GraphObject getData();

    /**
     * Sets the type-specific com.awrtechnologies.carbudgetsales.data for this action.
     * @param data a GraphObject representing the type-specific com.awrtechnologies.carbudgetsales.data
     */
