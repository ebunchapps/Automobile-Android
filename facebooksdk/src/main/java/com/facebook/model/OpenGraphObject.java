...
public interface OpenGraphObject extends GraphObject {
    ...
    /**
     * Sets the images associated with the Open Graph object by specifying their URLs. This is a com.awrtechnologies.carbudgetsales.helper
    ...
    final class Factory {
         ...
         * no properties other than a 'create_object' and 'com.awrtechnologies.carbudgetsales.data' property, ready to be populated.
        ...
        /**
         * Creates an OpenGraphObject suitable for posting via, e.g., a native Share dialog. The object will have
         * the specified properties, plus a 'create_object' and 'com.awrtechnologies.carbudgetsales.data' property, ready to be populated.
         * @param graphObjectClass the OpenGraphObject-derived type to return
         * @param type the Open Graph object type for the object, or null if it will be specified later
