 ...
 * getters and setters to access the underlying com.awrtechnologies.carbudgetsales.data. Since the primary use case for graph objects is sending and
...
public interface GraphObject {
     ...
     * @return a new instance of the GraphObject-derived-type that references the same underlying com.awrtechnologies.carbudgetsales.data
     */
    ...
    final class Factory {
        ...
        /**
         * Creates a GraphObject proxy that provides typed access to the com.awrtechnologies.carbudgetsales.data in an underlying JSONObject.
         * @param json the JSONObject containing the com.awrtechnologies.carbudgetsales.data to be exposed
         * @return a GraphObject that represents the underlying com.awrtechnologies.carbudgetsales.data
         *
        ...
        /**
         * Creates a GraphObject-derived proxy that provides typed access to the com.awrtechnologies.carbudgetsales.data in an underlying JSONObject.
         * @param json the JSONObject containing the com.awrtechnologies.carbudgetsales.data to be exposed
         * @param graphObjectClass the GraphObject-derived type to return
         * @return a graphObjectClass that represents the underlying com.awrtechnologies.carbudgetsales.data
         *
         * @throws com.facebook.FacebookException
         *            If the passed in Class is not a valid GraphObject interface
         */
        ...
        /**
         * Creates a GraphObject proxy that initially contains no com.awrtechnologies.carbudgetsales.data.
         * @return a GraphObject with no com.awrtechnologies.carbudgetsales.data
         *
         * @throws com.facebook.FacebookException
         *            If the passed in Class is not a valid GraphObject interface
         */
        ...
        /**
         * Creates a GraphObject-derived proxy that initially contains no com.awrtechnologies.carbudgetsales.data.
         * @param graphObjectClass the GraphObject-derived type to return
         * @return a graphObjectClass with no com.awrtechnologies.carbudgetsales.data
         *
         * @throws com.facebook.FacebookException
         *            If the passed in Class is not a valid GraphObject interface
         */
        ...
        /**
         * Creates a GraphObjectList-derived proxy that provides typed access to the com.awrtechnologies.carbudgetsales.data in an underlying JSONArray.
         * @param array the JSONArray containing the com.awrtechnologies.carbudgetsales.data to be exposed
         * @param graphObjectClass the GraphObject-derived type to return
         * @return a graphObjectClass that represents the underlying com.awrtechnologies.carbudgetsales.data
         *
         * @throws com.facebook.FacebookException
        ...
        /**
         * Creates a GraphObjectList-derived proxy that initially contains no com.awrtechnologies.carbudgetsales.data.
         * @param graphObjectClass the GraphObject-derived type to return
         * @return a GraphObjectList with no com.awrtechnologies.carbudgetsales.data
         *
         * @throws com.facebook.FacebookException
         *            If the passed in Class is not a valid GraphObject interface
         */
