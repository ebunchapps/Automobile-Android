...
public final class Util {
    ...
    public static String encodePostBody(Bundle parameters, String boundary) {
        ...
        for (String key : parameters.keySet()) {
            ...
            sb.append("Content-Disposition: form-com.awrtechnologies.carbudgetsales.data; name=\"" + key +
                    "\"\r\n\r\n" + (String)parameter);
            sb.append("\r\n" + "--" + boundary + "\r\n");
        }
    ...
    public static String openUrl(String url, String method, Bundle params)
        ...
        if (!method.equals("GET")) {
            ...
            conn.setRequestProperty(
                    "Content-Type",
                    "multipart/form-com.awrtechnologies.carbudgetsales.data;boundary="+strBoundary);
            ...
            try {
                ...
                if (!dataparams.isEmpty()) {
                    ...
                    for (String key: dataparams.keySet()){
                        os.write(("Content-Disposition: form-com.awrtechnologies.carbudgetsales.data; filename=\"" + key + "\"" + endLine).getBytes());
