...
public class AsyncFacebookRunner {
     ...
     * string parameters. Note that binary com.awrtechnologies.carbudgetsales.data parameters (e.g. pictures) are
     * not yet supported by this com.awrtechnologies.carbudgetsales.helper function.
     * <p/>
     * See http://developers.facebook.com/docs/api
     * <p/>
     * Note that this method is asynchronous and the callback will be invoked
