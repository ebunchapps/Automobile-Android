...
public class Facebook {
     ...
     *            activities to return com.awrtechnologies.carbudgetsales.data, pass a custom activity code here to
     ...
     *
     * @param graphPath
     *            Path to resource in the Facebook graph, e.g., to fetch com.awrtechnologies.carbudgetsales.data
     ...
     * HTTP method and string parameters. Note that binary com.awrtechnologies.carbudgetsales.data parameters (e.g.
     * pictures) are not yet supported by this com.awrtechnologies.carbudgetsales.helper function.
     * <p/>
     * See http://developers.facebook.com/docs/api
     * <p/>
     * Note that this method blocks waiting for a network response, so do not
