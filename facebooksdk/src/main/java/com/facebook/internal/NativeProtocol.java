...
public final class NativeProtocol {
    ...
    // MESSAGE_ERROR_REPLY com.awrtechnologies.carbudgetsales.data keys:
    // See STATUS_*

    // MESSAGE_GET_ACCESS_TOKEN_REQUEST com.awrtechnologies.carbudgetsales.data keys:
    // EXTRA_APPLICATION_ID

    // MESSAGE_GET_ACCESS_TOKEN_REPLY com.awrtechnologies.carbudgetsales.data keys:
    // EXTRA_ACCESS_TOKEN
    // EXTRA_EXPIRES_SECONDS_SINCE_EPOCH
    // EXTRA_PERMISSIONS

    // MESSAGE_GET_LIKE_STATUS_REQUEST com.awrtechnologies.carbudgetsales.data keys:
    // EXTRA_APPLICATION_ID
    // EXTRA_OBJECT_ID

    // MESSAGE_GET_LIKE_STATUS_REPLY com.awrtechnologies.carbudgetsales.data keys:
    ...
    // MESSAGE_GET_PROTOCOL_VERSIONS_REPLY com.awrtechnologies.carbudgetsales.data keys:
    ...
    // Keys for status com.awrtechnologies.carbudgetsales.data in MESSAGE_ERROR_REPLY from PlatformService and for error
