...
public class UiLifecycleHelper {
     ...
     *
     * @param activity the Activity associated with the com.awrtechnologies.carbudgetsales.helper. If calling from a Fragment,
     ...
     * @param data the result com.awrtechnologies.carbudgetsales.data
     */
