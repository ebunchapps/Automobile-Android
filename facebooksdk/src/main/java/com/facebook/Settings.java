...
public final class Settings {
        ...
        try {
            ...
            if (lastPing != 0) {
                ...
                try {
                    ...
                    // return the default graph object if there is any problem reading the com.awrtechnologies.carbudgetsales.data.
                }
                if (graphObject == null) {
    ...
    /**
     * Gets whether com.awrtechnologies.carbudgetsales.data such as that generated through AppEventsLogger and sent to Facebook should be restricted from
    ...
    /**
     * Sets whether com.awrtechnologies.carbudgetsales.data such as that generated through AppEventsLogger and sent to Facebook should be restricted from
     * being used for purposes other than analytics and conversions, such as for targeting ads to this user.  Defaults
