...
public class Session implements Serializable {
    ...
    Session(Context context, String applicationId, TokenCachingStrategy tokenCachingStrategy,
        ...
        // meta-com.awrtechnologies.carbudgetsales.data in the manifest.
    ...
    /**
     * Returns a Bundle containing com.awrtechnologies.carbudgetsales.data that was returned from Facebook during
     * authorization.
     *
     * @return a Bundle containing com.awrtechnologies.carbudgetsales.data that was returned from Facebook during
     *         authorization.
     */
    ...
    /**
     * Internal com.awrtechnologies.carbudgetsales.helper class that is used to hold two different permission lists (granted and declined)
     */
     ...
     * com.awrtechnologies.carbudgetsales.data.
     *
     ...
     *                        call.
     * @param data            The Intent passed as the com.awrtechnologies.carbudgetsales.data parameter from the forwarded
     *                        call.
     ...
     *                        null, a default token cachingStrategy that stores com.awrtechnologies.carbudgetsales.data in
