...
/**
 * Class to encapsulate an app link, and provide methods for constructing the com.awrtechnologies.carbudgetsales.data from various sources
 */
public class AppLinkData {
    ...
    /**
     * Parses out any app link com.awrtechnologies.carbudgetsales.data from the Intent of the Activity passed in.
    ...
    private static AppLinkData createFromJson(String jsonString) {
        ...
        try {
            // Any missing or malformed com.awrtechnologies.carbudgetsales.data will result in a JSONException
    ...
    /**
     * The referer com.awrtechnologies.carbudgetsales.data associated with the app link. This will contain Facebook specific information like
     * fb_access_token, fb_expires_in, and fb_ref.
     * @return the referer com.awrtechnologies.carbudgetsales.data.
     */
    ...
    public interface CompletionHandler {
        /**
         * This method is called when deferred app link com.awrtechnologies.carbudgetsales.data has been fetched. If no app link com.awrtechnologies.carbudgetsales.data was found,
         * this method is called with null
         * @param appLinkData The app link com.awrtechnologies.carbudgetsales.data that was fetched. Null if none was found.
         */
