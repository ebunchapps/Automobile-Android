...
public class TestSession extends Session {
    ...
    private static synchronized void retrieveTestAccountsForAppIfNeeded() {
        ...
        // The com.awrtechnologies.carbudgetsales.data we need is split across two different graph API queries. We construct two queries, submit them
        ...
        testUserNamesParam.putString("ids", "{result=testUsers:$.com.awrtechnologies.carbudgetsales.data.*.id}");
