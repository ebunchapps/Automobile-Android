 ...
 * </p>
 * <p>
 * The com.awrtechnologies.carbudgetsales.data to be cached is passed in via a Bundle. Only non-null key-value-pairs where
...
public class SharedPreferencesTokenCachingStrategy extends TokenCachingStrategy {
    ...
    /**
     * Persists all supported com.awrtechnologies.carbudgetsales.data types present in the passed in Bundle, to the
     * cache
     *
     * @param bundle
